...
\begin{itemize}
	...
	\end{itemize}
	Es werden zur Reinigung der Zuluft entweder Taschenfilter oder Kassettenfilter verwendet. Um Gerüche aus der Luft zu filtern \zB in Küchen werden Aktivkohlefilter verwendet. Bei beiden Filterarten ist es wichtig diese in regelmäßigen Abständen zu säubern oder ersetzten.  
