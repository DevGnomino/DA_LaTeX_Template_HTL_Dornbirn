...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{Bilder/Umweltanalyse}
...
\begin{table}[H]
	...
	\begin{tabular}{p{\dimexpr 0.30\textwidth-2\tabcolsep} | p{0.20\textwidth} | p{0.15\textwidth} | p{0.30\textwidth}}
		\toprule
