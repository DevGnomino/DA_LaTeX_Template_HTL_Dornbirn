\subsection{\textit{Tkinter} und \textit{CustomTkinter}}\label{tkinter_kapitel}
...
\begin{minipage}{0.37\textwidth}
	\centering	
	\includegraphics[width=0.6\textwidth]{ctk_logo}
	\captionof{figure}[\gls{gls_ctk} Logo (Quelle: \url{https://github.com/tomschimansky/customtkinter?tab=readme-ov-file}, Zugriff am 25.02.2024)]{\gls{gls_ctk} Logo (Quelle: 
