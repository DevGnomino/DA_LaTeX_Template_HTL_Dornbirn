...
{
	name=CR,
	description={gls{ASCII} Kontrollzeichen. Bewegt den Cursor an den Anfang der Zeile \cite{Mozilla_CRLF:2023}.}
}

\newglossaryentry{lf}
{
	name=LF,
	description={gls{ASCII} Kontrollzeichen. Bewegt den Cursor eine Zeile nach unten \cite{Mozilla_CRLF:2023}.}
}
