...
\begin{figure}[H]
	...
	\caption[\gls{modbus} Dataframe (Quelle: \url{https://modbus.org/docs/Modbus_Application_Protocol_V1_1b3.pdf} (angepasst), Zugriff am 24.01.2024)]{\gls{modbus} Dataframe (Quelle: \url{https://modbus.org/docs/Modbus_Application_Protocol_V1_1b3.pdf})}
...
\begin{figure}[H]
	...
	\caption[\gls{modbus} Daten in separaten Blöcken (Quelle: \url{https://modbus.org/docs/Modbus_Application_Protocol_V1_1b3.pdf}, Zugriff am 24.01.2024)]{\gls{modbus} Daten in separaten Blöcken (Quelle: \url{https://modbus.org/docs/Modbus_Application_Protocol_V1_1b3.pdf})}
	\label{fig:modbus_register_many_blocks}
\end{figure}

Alternativ können die Blöcke auch zusammen geschaltet werden. Die Register können immer noch durch die Function Codes erreicht werden, benötigen aber zusätzliche Eingaben in Form von zusätzlichen Bits (Siehe Abb.~\ref{fig:modbus_register_one_block}).
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\linewidth]{Bilder/Modbus_Data_Model_with_one_block}
	\caption[\gls{modbus} Daten in einem Block (Quelle: \url{https://modbus.org/docs/Modbus_Application_Protocol_V1_1b3.pdf}, Zugriff am 24.01.2024)]{\gls{modbus} Daten in einem Block (Quelle: \url{https://modbus.org/docs/Modbus_Application_Protocol_V1_1b3.pdf})}
...
\begin{figure}[H]
	...
	\caption[\gls{modbus} \acs{rtu} Frame (Quelle: \url{https://www.modbus.org/docs/Modbus_over_serial_line_V1.pdf}, Zugriff am 27.01.2024)]{\gls{modbus} \acs{rtu} Frame (Quelle: \url{https://www.modbus.org/docs/Modbus_over_serial_line_V1.pdf})}
...
\begin{figure}[H]
	...
	\caption[\gls{gls_rs485} Signal (Quelle: \url{https://www.lorric.com/en/WhyLORRIC/Flowmeter/what-is-rs485}, Zugriff am 22.02.2024)]{\gls{gls_rs485} Signal (Quelle: \url{https://www.lorric.com/en/WhyLORRIC/Flowmeter/what-is-rs485})}
