...
\begin{itemize}
	...
	\item \textbf{Modbus Plus:} Funktioniert mittels Tokens, die von einem Gerät zum nächsten wandern. Jeweils das Gerät, das den Token hat, ist der Client. (https://www.rtautomation.com/rtas-blog/good-bye-modbus-plus/) LINK IN QUELLEN EINBAUEN
\end{itemize}
